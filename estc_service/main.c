...
static ble_uuid_t m_adv_uuids[] = /**< Universally unique service identifiers. */
    {
        ...
        // DONE: 5. Add ESTC service UUID to the table
        {RANDOM_SERVICE_UUID, BLE_UUID_TYPE_BLE}
};
...
static void advertising_init(void)
{
    ...
    // DONE: 6. Consider moving the device characteristics to the Scan Response if necessary
